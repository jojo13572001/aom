...
void aom_compute_flow_at_point_c(const uint8_t *frm, const uint8_t *ref, int x, int y, int width, int height, int stride, double *u, double *v);
...
double av1_compute_cross_correlation_c(const unsigned char *im1, int stride1, int x1, int y1, const unsigned char *im2, int stride2, int x2, int y2);
